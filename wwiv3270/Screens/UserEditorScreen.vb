    ...
    Public Class UserEditorScreen
        ...
        Private Sub RenderTN3270(session As TN3270SessionAdapter)
            ...
            If _editMode AndAlso _selectedIndex >= 0 AndAlso _selectedIndex < _userList.Count Then
                ...
                Select Case _editField
                    Case "sl"
                        tn.WriteText(22, 40, "Security Level:")
                        tn.AddField(22, 57, 3, user.SecurityLevel.ToString(), False, TN3270Color.Green, TN3270Color.Neutral, TN3270Highlight.Underline, "editvalue")
                    Case "dsl"
                        tn.WriteText(22, 40, "DL Security:")
                        tn.AddField(22, 57, 3, user.DownloadSecurityLevel.ToString(), False, TN3270Color.Green, TN3270Color.Neutral, TN3270Highlight.Underline, "editvalue")
                    Case "delete"
            ...
            Dim statusText = If(_editMode, "ENTER=Save  ESC=Cancel", "↑↓=Select  E=Edit SL  D=Delete  Q=Quit")
        ...
        Private Sub HandleTN3270Input(session As TN3270SessionAdapter, e As AidKeyEventArgs)
            ...
            Else
                ...
                Select Case e.AidKey
                    Case &H7D ' ENTER - Edit selected user
            ...
            Select Case _editField
                Case "sl"
                    ...
                    If Integer.TryParse(value, sl) AndAlso sl >= 0 AndAlso sl <= 255 Then
                        ...
                        Console.WriteLine($"Updated user #{user.UserNumber} SL to {sl}")
                    End If
                ...
                Case "dsl"
                    ...
                    If Integer.TryParse(value, dsl) AndAlso dsl >= 0 AndAlso dsl <= 255 Then
                        ...
                        _userService.SaveUser(user)
                        Console.WriteLine($"Updated user #{user.UserNumber} DSL to {dsl}")
                    End If
                ...
                Case "delete"
                    If value?.ToUpper() = "Y" Then
                        ...
                        End If
                        Console.WriteLine($"Deleted user #{user.UserNumber}")
                    End If
            End Select
        End Sub
    End Class
